...
4. [Option] SSH installer script: Log into your VenusOS device and run this script to install the latest version. This can also be used to update to the latest version. You will need to have [root access](https://www.victronenergy.com/live/ccgx:root_access) 
